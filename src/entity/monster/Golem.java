	...
	public void draw(Graphics2D g) {
		...
		if(hp==0){ //dead
			if(direction==1){
				...
				g.drawImage(Resource.monster_golem_1_2_f.getSubimage(Resource.monster_golem_1_2_f.getWidth() / 7
						* (6-frameCountDead), 0, Resource.monster_golem_1_2_f.getWidth() / 7,
			...
			if(direction==1){
				...
				g.drawImage(Resource.monster_golem_1_3_f.getSubimage(0, 0, Resource.monster_golem_1_3_f.getWidth(),
			...
			if(direction==1){
				...
				g.drawImage(Resource.monster_golem_1_1_f.getSubimage(Resource.monster_golem_1_1_f.getWidth() / 4
						* (3-frameCountWalk), 0, Resource.monster_golem_1_1_f.getWidth() / 4,
