	...
	public void draw(Graphics2D g) {
		if (hp == 0) { // dead
			g.drawImage(Resource.monster_golem_1_2.getSubimage(
					Resource.monster_golem_1_2.getWidth() / 7 * frameCountDead,
					0, Resource.monster_golem_1_2.getWidth() / 7,
			...
			g.drawImage(Resource.monster_golem_1_1.getSubimage(
					Resource.monster_golem_1_1.getWidth() / 4 * frameCountWalk,
					0, Resource.monster_golem_1_1.getWidth() / 4,
